  ...
  <div class="content-wrapper" ><br>
    <div class="container" style="background-color: white">
      ...
      <h1>
        <strong class="text-green"> Control de Menu </strong> <br>  
        <small>- Consultas, Actualizacion y Registro</small>
        
      </h1>
      <ol class="breadcrumb">
        
       <button type="submit" class="btn btn-success" data-toggle="modal" data-target="#modalMenu">Nuevo Menú</button>
      </ol>
    </section>
<br>
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="box-header with-border">
              <h3 class="box-title text-green">LISTA DE MENU</h3>
            </div>
  ...
  <div class="modal-dialog modal-lg" >
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h2 class="modal-title text-green">Registro de Menu</h2>

      </div>
      <div class="modal-body">

        <form role="form" id="frmMenu">
                ...
                <div class="row"> 
                 ...
                 <div class="row">  
                  ...
                  <textarea class="form-control text-green" name="txtdescripcion" id="txtdescripcion"></textarea>
